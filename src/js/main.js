...
var navPanelMobile = document.querySelector('nav-panel-mobile')
...
window.onload = () => {
  ...
  navToggle.addEventListener('onclick', () => {
      ...
      if (index < 0) {
        ...
        if (window.location.hostname.charAt(0) === '1') {
          var fullURL =
            ...
            ':8080/' //for node testing
        } else {
          var fullURL =
            window.location.protocol + '//' + window.location.hostname + '/' //for server
        }
      } else {
